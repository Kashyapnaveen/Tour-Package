    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="<?php echo e(route('create_pacakgeApi')); ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="package_destination" class="form-control">
                                </div>
                                <!-- /.input group -->
                            </div>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\PHP TASK DAILY\FRONTEND\laravel_call_api\resources\views/create_pacakge.blade.php ENDPATH**/ ?>